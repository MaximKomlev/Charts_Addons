...
public func backgroundGradient() -> CAGradientLayer {
    ...
    //    let color2 = UIColor(red: 170 / 255, green: 221 / 255, blue: 255 / 255, alpha: 1.0).cgColor
    //    gradientLayer.colors = [color1, color2,]
    //    gradientLayer.locations = [0.0, 0.5]
    
    //    let color1 = UIColor(red: 237 / 255, green: 244 / 255, blue: 249 / 255, alpha: 1.0).cgColor
    //    let color2 = UIColor(red: 220 / 255, green: 228 / 255, blue: 242 / 255, alpha: 1.0).cgColor
    //    let color3 = UIColor(red: 237 / 255, green: 244 / 255, blue: 249 / 255, alpha: 1.0).cgColor
